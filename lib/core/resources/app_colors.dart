...
class AppColors {
  static Color primaryColor = ColorManager.primary;
  static Color whiteColor = ColorManager.white;
  static Color blackColor = ColorManager.black;
  static Color greyColor = ColorManager.grey;
}
